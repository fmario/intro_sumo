...
static void REF_HardCalibrate(SensorTimeType min[REF_NOF_SENSORS], SensorTimeType max[REF_NOF_SENSORS]){
  int i;
...
void REF_SetMeasur(void){
  REF_HardCalibrate(SensorCalibMinMax.minVal, SensorCalibMinMax.maxVal);
